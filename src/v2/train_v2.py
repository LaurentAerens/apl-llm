...
def train_v2(args):
    ...
    print(f"[+] Initializing APL SLM v2 Training on device: {device}")
    ...
    print(f"[+] APL SLM v2 initialized with {model.count_parameters():,} trainable parameters.")
    ...
    patience_counter = 0
    history = {"experiment": args.exp_name, "version": 2, "epochs": []}
