"""
Architecture Version 3 Autocomplete Wrapper.
Provides load_model_v3 and autocomplete_v3 delegating to the unified APLGenerator.
"""
...
def load_model_v3(checkpoint_path: str = "checkpoints/apl_slm_best.pt", device_str: Optional[str] = None):
